...
shared_ptr<ModuleContext> posix_initialize(GlobalContext *global_context)
{
    ...
    vector<BuiltinFunctionDefinition> module_function_defs({
                                                                   ...
                                                                   {"dup2", {Int}, Int, simple_wrapper(dup2(fd, new_fd), int64_t fd, int64_t new_fd, ExceptionBlock *exc_block),
                                                                    true},

                                                                   {"fork", {}, Int, simple_wrapper(fork(), ExceptionBlock *exc_block), true},

                                                                   {"kill", {Int, Int}, Int, simple_wrapper(kill(pid, sig), int64_t pid, int64_t sig, ExceptionBlock *exc_block),
                                                                    true},
                                                                   {"killpg", {Int, Int}, Int,
                                                                   ...
                                                                   {"execv", {Unicode, List_Unicode}, None,
