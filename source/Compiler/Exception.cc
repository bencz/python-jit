...
void raise_python_exception_with_message(ExceptionBlock *exc_block, int64_t class_id, const char *message)
{
...
void raise_python_exception_with_format(ExceptionBlock *exc_block, int64_t class_id, const char *fmt, ...)
{
    void *exc;
